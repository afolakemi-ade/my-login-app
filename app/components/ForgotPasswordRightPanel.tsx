...
import styles from '../styles/ForgotPasswordRightPanel.module.css';
import CountrySelector from './CountrySelector';

export default function ForgorPasswordRightPanel() {
  return (
      <div className={styles.rightPanel}>
        

          <div className={styles.content}>
               <Image src='/Progress.svg' alt='ProgressBar' width={454} height={4} />
      <div className={styles.header}>
        ...
        <div className={styles.imageWrapper}>
              <div className={styles.picture}>
                  <Image src='/Group 75.svg' alt='picture' width={211.85} height={400} />
                  </div>
              </div>
              </div>
