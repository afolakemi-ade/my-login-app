        ...
        <header className={styles.head}>
          <div>
            <button className={styles.button1}>
              ...
              />
              <span className={styles.ngn}>Nigeria (NGN)</span>
            </button>
          </div>
          <div>
          ...
          <div>
            <div className={styles.sticks}>
              ...
              <div className={styles.note1}>
                ...
                online-all
                <br />
                <span className={styles.with}>without building a website.</span>
              </div>
              <div className={styles.butt}>
                <button className={styles.bluee}>Create Your Free Store</button>
                <button className={styles.white}>Create Your Free Store</button>
              </div>
            </div>
          ...
          <div className={styles.fourboxes}>
            <div className={styles.box}>
              ...
              <div className={styles.subsub}>
                No coding. No design skills. Just add your menu items, set your
                prices,and you are ready to go.
              </div>
            </div>
            <div className={styles.box2}>
              ...
              <br />
              <div className={styles.subsub}>
                Receive payments instantly and via card, USSD, bank transfer, or
                mobile money.
              </div>
            </div>
          </div>
